...
using System.Linq;
using CodeSampleExpressCheckout.Model.PayPal;
using System.Web;
using CodeSampleExpressCheckout.Model.PayPal.Enum;
using CodeSampleExpressCheckout.Model.PayPal.ExpressCheckout.Enum;
using CodeSampleExpressCheckout.Model.PayPal.ExpressCheckout;
using CodeSampleExpressCheckout.Model.PayPal.Nvp;
using CodeSampleExpressCheckout.Model.CodeSampleExpressCheckout;
	...
	public class Checkout {
		...
		private static ExpressCheckoutApi expressCheckout() {
            string email = "vendet_1342445626_biz_api1.imasters.com.br";
            string password = "1342445650";
            string apiKey = "AESENuJjs8TWVTA5bu0r1S9cGLLHA.DG.Oe0Je7I78YUAQMhcK5JsxDD";
